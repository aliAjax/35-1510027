import { Search, Plus, Heart, BookMarked, BookOpen, Clock, FileSpreadsheet, Tags, CalendarCheck, Copy } from 'lucide-react';
import { useEntryStore } from '../store/useEntryStore';
import { BackupRestore } from './BackupRestore';

export const SearchBar = () => {
  const { filters, setFilters, openForm, openBatchImport, openTagManager, openReadingPlan, openDuplicateChecker, getStats } = useEntryStore();
